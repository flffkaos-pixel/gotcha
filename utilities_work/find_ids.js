...
const OUT = String.raw`C:\Users\중진공39\utilities_work\undefined_ids.json`;
...
fs.writeFileSync(OUT, JSON.stringify(filesWithMissings, null, 2));
console.log('filesWithMissings:', filesWithMissings.length, ' totalRefs:', totalUndefinedRefs);
for (const x of filesWithMissings.slice(0, 50)) console.log(x.file, '->', x.missing.join(','));
